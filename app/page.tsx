        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-xl border border-zinc-200 dark:border-zinc-800 p-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white dark:bg-zinc-100 text-zinc-900 dark:text-zinc-900 px-6 py-3 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-200 transition-all duration-200 shadow-lg hover:shadow-xl border border-zinc-200 dark:border-zinc-300"
            >
              <svg 
                className="w-6 h-6" 
                viewBox="0 0 24 24" 
